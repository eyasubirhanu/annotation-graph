...
static void configureNiceLayout(ScalingLayout *sl, MultilevelBuilder *&merger,
...
static void PlanarStraightLayoutAlg(GraphAttributes &GA) {
...
static bool isGO(const Value &data) {
  ...
  return type == "biologicalprocess" || type == "cellularcomponent" ||
